...
// //         if (soViThe && !isNaN(soViThe)) {
// //             const lenh = soViThe > 0 ? "SHORT" : "LONG";
// //             runBotNormal(lenh, "MTL", Math.abs(soViThe));
// //             add_logs("Tự động đóng vị thế cuối ngày");
// //         }
// //     }
// // }

// // // ==== ĐOẠN CODE THÊM VÀO ĐỂ TỰ ĐỘNG ĐÓNG VỊ THẾ CUỐI NGÀY ====
// // function checkAndClosePosition() {
// //     const now = new Date();
// //     const hours = now.getHours();
// //     const minutes = now.getMinutes();
...
// //         const vitheCell = $('#danhmuc_' + stockCode).children('td').eq(1);

// //         if (!vitheCell || vitheCell.length === 0) return;

// //         const vithe = vitheCell.html();
// //         if (vithe && vithe !== '-' && vithe !== 'undefined') {
// //             const soViThe = parseInt(vithe);
// //             if (!isNaN(soViThe) && soViThe !== 0) {
// //                 const lenh = soViThe > 0 ? "SHORT" : "LONG";
// //                 runBotNormal(lenh, "MTL", Math.abs(soViThe));
// //                 add_logs("Tự động đóng vị thế cuối ngày");
// //             }
...
//     console.log(isPositionClosedMorning)
...
//                 console.log(theoDoiTrangThaiDatlenhInterval)
//                 console.log(obsNangTP)
...
//                 add_logs("Da dat lenh thanh cong")
//                 // }
//             })
//         }
//         else {
...
//             console.log("=== runBotNormal bat dau ===");
//             console.log("tinhieu:", tinhieu);
//             console.log("giadat:", giadat);
//             console.log("hopdong:", hopdong);

//             console.log("Hien thi nut cancel-all-confirm");
//             $('.cancel-all-confirm').css('display', '');

//             console.log("Bo check stopOrder neu co");
//             $('#use_stopOrder').prop('checked', false);

//             console.log("Cap nhat modal_price voi:", giadat);
//             $('#modal_price').text(giadat);

//             console.log("Tat xac nhan lenh (objConfig.CONFIRM_ORDER = false)");
//             objConfig.CONFIRM_ORDER = false;

//             console.log("Cap nhat right_price voi:", giadat);
//             $("#right_price").val(giadat);

//             console.log("Cap nhat sohopdong voi:", hopdong);
//             $("#sohopdong").val(hopdong);

//             const loaiLenh = tinhieu === "LONG" ? "B" : "S";
//             console.log("Loai lenh:", loaiLenh);
//             $('input[name="type"]').val(loaiLenh);

//             if (isDemo) {
//                 const btn = document.getElementById("acceptCreateOrder");

//                 if (btn) {
//                     console.log("Tim thay nut #acceptCreateOrder");
//                     const onclickCode = btn.getAttribute("onclick"); // Lay code trong onclick
//                     console.log("Noi dung onclick:", onclickCode);

//                     // Thuc thi doan code onclick giong nhu click that
//                     eval(onclickCode);
//                 } else {
//                     console.log("Khong tim thay nut #acceptCreateOrder");
//                 }
                
//             } else {
//                 console.log("Dang o che do THAT -> fake click Xac nhan");
//                 // $("#acceptCreateOrder").trigger("click");
//             }


//             console.log(`Ghi log: Da dat lenh ${tinhieu} gia ${giadat} voi ${hopdong} hop dong`);
//             add_logs(`Đã đặt lệnh ${tinhieu} giá ${giadat} với ${hopdong} hợp đồng `);
//             console.log("=== runBotNormal ket thuc ===");
//         };

//         runBotNormal("LONG", 2000, 1)
...
//                             // if (lastTP) {
//                             //     add_logs(`Lệnh trước đã TP ${lastTP.level}, bắt đầu đảo chiều}`)
//                             //     if(lastTP.level === "TP1"){
//                             //         tiLeDao = 1.5
//                             //     }
...
//                             //     }
//                             // }
//                             // const hopDongDao = Math.round(ngDat * tiLeDao)
//                             // my_hd = hopDongDao - Math.abs(soViThe)
//                             // fullHopdong = hopDongDao
//                         }
//                     }
//                 }
...
//                 if (soViThe) {
//                     // if(!soSucMua){
//                     //     add_logs("Không có sức mua , không thế nhồi thêm")
//                     //     return;
//                     // } //sua
//                     if (isAdmin) {
//                         if (fullHopdong > ngDat) {
...
//                         const lastTP = JSON.parse(localStorage.getItem("lastTP"))
//                         if (lastTP) {
//                             add_logs(`Lệnh trước đã TP ${lastTP.level} tại giá ${lastTP.price},
//                               SL: ${lastTP.contracts} hợp đồng lúc ${lastTP.time}`)
...
//                                             huyLenhDieuKien()
//                                             add_logs("Huy lenh sau khi chot tp1")
...
//                                             huyLenhDieuKien()
//                                             add_logs("Huy lenh sau khi chot tp2")
...
//                                             add_logs("Huy lenh sau khi cat lo")
